...
posts=[
	{
	'penulis':'nining s kamala',
	'title':"blog post 1",
	'konten':'ini adalah post pertama saya',
	'tgl_post':'oktober 03, 1998',
	},
	{
	'penulis':'idulfitri madea',
	'title':"blog post 2",
	'konten':'ini adalah post pertama saya',
	'tgl_post':'maret 03, 1994',
	},
]
...
@app.route("/jadwal")
def jadwal():
	return render_template("jadwal.html", title='Jadwal')
...
def login():
	...
	if form.validate_on_submit(): 
		...
		# if form.email.data =='nining@gmail.com' and form.password.data =='admin':
